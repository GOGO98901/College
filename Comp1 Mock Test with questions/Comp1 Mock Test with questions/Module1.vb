Module Module1
    ...
    Function CheckValidMove(ByVal XCoordinate As Integer, ByVal YCoordinate As Integer, ByVal Board(,) As Char)
        ...
        If ValidMove Then
            If Board(XCoordinate, YCoordinate) = "X" Or Board(XCoordinate, YCoordinate) = "O" Then ValidMove = False
        End If
    ...
    Function CheckXOrOHasWon(ByVal Board(,) As Char) As Boolean
        ...
        If Board(1, 3) = Board(2, 2) And Board(2, 2) = Board(3, 1) And Board(3, 1) <> " " Then XOrOHasWon = True
